  ...
  return (
    <header data-header className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b">
      <div className="mx-auto max-w-6xl px-4 h-14 flex items-center justify-between">
        <Link href="/" className="inline-flex items-center" aria-label="Go to homepage" prefetch={false}>
          <Image src="/images/logo.png" alt="PROTON Dealer" width={500} height={148} priority className="h-20 w-auto" />
